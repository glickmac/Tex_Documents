...
\begin{tabular}{@{}lllll@{}}
\toprule
{\ul \textbf{Projects}} & {\ul \textbf{Status}} & {\ul \textbf{Goals (To-Do)}} & {\ul \textbf{Done This Week}} & {\ul \textbf{Comments}} \\ \midrule
...
GRAB & Development & Package Development &  & Incorporate SequenceServer \\ \bottomrule
\end{tabular}%
}
\end{table}
