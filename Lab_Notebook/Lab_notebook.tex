...
Downloaded phage protein data searching by taxonomy from Uniprot/TrEmbL. Dowloaded three datasets Claudioviruses, Ligamenvirales, and Unclassified
...
\begin{center}
\includegraphics[width=0.5\linewidth]{images/example_figure}
\end{center}
