...
\date{May 2nd 2018} % Beginning date
\maketitle
...
\textbf{Found Github Repository for \href{www.google.com}{Something Similar} }


\experiment{CAMI_Filter}

Environments have been set-up and are ready to roll. The binner (MaxBin2) requires the raw reads to calculate abundances needed for binning. The CAMI data \href{www.google.com}{website} contains dead links to retrieve reads. Will need to reach out to authors for data.  
